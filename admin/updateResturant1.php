...
if (isset($_GET['id'])) {
    ...
    $sql2 = "SELECT * FROM table_resturant1 WHERE id=$id";
...
<div class="main-content">
    <div class="wrapper">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value="Update Resturant1" class="btn-secondary">
                    </td>
                </tr>
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql3 = "UPDATE table_resturant1 SET 
                    title = '$title',
            ...
            if ($res3 == true) {
                ...
                echo "<script> window.location.href = 'manageResturant1.php'; </script>";
            } else {
                //Failed to Update Food
                $_SESSION['update'] = "<div class='error'>Failed to Update Resturant.</div>";
                header('location:' . SITEURL . 'admin/manageRresturant1.php');
            }
        }
