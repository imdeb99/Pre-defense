    ...
    <div class="main-content">
        <div class="wrapper">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (isset($_FILES['image']['name'])) {
                    ...
                    if ($image_name != "") {
                        ...
                        if ($upload == false) {
                            ...
                            header('location:' . SITEURL . 'admin/addResturant1.php');
                            //STop the process
                            die();
                        }
                    }
                ...
                $sql2 = "INSERT INTO `table_resturant1`(`title`, `description`, `image_name`, `category_id`, `featured`, `active`) VALUES ('$title','$description','$image_name','$category','$featured','$active')";
